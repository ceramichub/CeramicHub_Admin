...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsLoading(true);
        try {
            const response = await fetch(`${("TURBOPACK compile-time value", "http://localhost:5001/api")}/user/login`, {
                method: "POST",
                headers: {
            ...
            login(data.data.token, data.data.userData.userName);
...
_s(LoginPage, "/ZgK5cQl/GuM3r+ZdbKq0p+89AY=", false, function() {
    return [
